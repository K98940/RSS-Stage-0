...
const stateObj = {
  ...
  intro: `Для проверяющих наверху есть переключатель для упрощения тестирования. Он уменьшает количество очков необходимых для победы.

    Там же, наверху, можно включить отображение цифровых значений на игровых блоках - если захочется чуть упростить игру.

    Крутые звуковые спецэффекты звучат только при первом появлении нового элемента - чтобы голова от восторга не заболела.

    Соревнуйтесь с Reviewer1 и да пребудет с вами сила.`,
}
